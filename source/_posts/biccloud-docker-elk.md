...
## How do I maintain Elasticsearch data?

Elasticsearch is periodically maintained by `biccloud-docker-curator`. **curator** allows operations to be performed on elasticsearch indices and snapshots.
